              ...
              <main className="prices-main1">
                ...
                <div className="prices-buttons">
                  <a
                    ...
                    className="prices-link1"
                  >
                    <div className="prices-get-started1 button">
                      <span className="prices-text1">Download App now</span>
                    </div>
                  </a>
                </div>
              </main>
          ...
          <section className="prices-note1">
            ...
            <div className="prices-content2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="prices-link2"
              >
                <div className="prices-get-started2 button">
                  <span className="prices-text2">Get started</span>
                </div>
              </a>
            </div>
          </section>
...
<div class="container">
      <div class="main-tabs">
         <button class="main-tab tab1 active" onclick="showSubTab('tab1')">Wash + Fold</button>
         <button class="main-tab tab2" onclick="showSubTab('tab2')">Wash + Iron</button>
         <button class="main-tab tab3" onclick="showSubTab('tab3')">Steam Iron</button>
         <button class="main-tab tab4" onclick="showSubTab('tab4')">Dry Clean</button>
      </div>
      <div class="sub-container">
         <div class="sub-tabs">
            <div id="tab1" class="sub-tab-content active">
               <button class="sub-tab active" onclick="showContent('content1')">Men</button>
               ...
               <button class="sub-tab" onclick="showContent('content4')">Household</button>
            </div>
            <div id="tab2" class="sub-tab-content">
               <button class="sub-tab active" onclick="showContent('content5')">Men</button>
               ...
               <button class="sub-tab" onclick="showContent('content8')">Household</button>
            </div>
            <div id="tab3" class="sub-tab-content">
               <button class="sub-tab active" onclick="showContent('content9')">Men</button>
               <button class="sub-tab" onclick="showContent('content10')">Women</button>
               <button class="sub-tab" onclick="showContent('content11')">Kids</button>
               <button class="sub-tab" onclick="showContent('content12')">Household</button>
            </div>
            <div id="tab4" class="sub-tab-content">
               <button class="sub-tab active" onclick="showContent('content13')">Men</button>
               <button class="sub-tab" onclick="showContent('content14')">Women</button>
               <button class="sub-tab" onclick="showContent('content15')">Kids</button>
               <button class="sub-tab" onclick="showContent('content16')">Household</button>
            </div>
         </div>
         <div class="content">
...
function showSubTab(tabId) {
    ...
    const selectedMainTab = document.querySelector(\`.main-tab[onclick="showSubTab('\${tabId}')"]\`);
...
`}
            ...
            <div className="prices-content3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="prices-link3"
              >
                <div className="prices-get-started3 button">
                  <span className="prices-text3">Get started</span>
                </div>
              </a>
            </div>
          </section>
